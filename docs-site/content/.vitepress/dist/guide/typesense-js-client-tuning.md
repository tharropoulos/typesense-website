...
[Search API caching parameters](/30.2/api/search.html#caching-parameters).
...
[the caching section](/30.2/api/search.html#caching-parameters) of the Search API reference.
...
[remote embedding timeout settings](/30.2/api/vector-search.html#remote-embedding-api-parameters)
