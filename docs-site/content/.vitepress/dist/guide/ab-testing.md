...
1. Any of the available [search parameters](/30.2/api/documents.html#search-parameters) like `sort_by`, `filter_by`, etc.
2. [Override/Curation Rules](/30.2/api/curation.html).
3. [Synonyms](/30.2/api/synonyms.html).
