...
[Read the docs](/30.2/api/natural-language-search.html#create-a-natural-language-search-model) on how to use this built-in feature.
...
Please refer to [API Keys](/30.2/api/api-keys.html#search-only-api-key) docs on how to generate a search-only-api key.
