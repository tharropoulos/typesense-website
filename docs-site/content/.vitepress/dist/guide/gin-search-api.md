...
- Add custom conditional authentication logic that gets evaluated on every request, in addition to what [scoped search API keys](/30.2/api/api-keys.html#generate-scoped-search-key) provide
