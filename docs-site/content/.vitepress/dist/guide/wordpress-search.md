...
#### Setup
If you are hosting Typesense locally or on your own server, generate your API Keys following the instructions here: [Generate API Keys](/30.2/api/api-keys.html).
...
* **Self-Hosted:** If you are running Typesense on your own server, generate your API keys following the instructions here: [Generate API Keys](/30.2/api/api-keys.html).
