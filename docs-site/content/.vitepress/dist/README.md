...
| [**Guide**](/guide/)                                                   | This section walks you step-by-step through how you can use Typesense in different scenarios.                                                                                                                                                 |
| [**API Reference**](/30.2/api/) | This section gives you detailed information about all the API endpoints and parameters in each version of Typesense. When you're viewing any of the versions, you can click on the version dropdown in the Navbar to switch between versions. |
