...
you can configure advanced [Typesense Server Configuration Parameters](/30.2/api/server-configuration.html) that control various aspects of Typesense's behavior, 
