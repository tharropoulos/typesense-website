...
|max_hits|no|Maximum number of records to consider from each field's index, in multi-field searches. Increasing this value might increase search latency.<br>`Default:250`|
