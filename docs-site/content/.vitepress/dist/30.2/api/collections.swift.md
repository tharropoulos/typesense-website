...
| synonym_sets          | no       | A list of [synonym sets](./synonyms.md#linking-synonym-sets-with-collections) linked to the collection. <br/><br/>Default: `[]`.               |
| curation_sets         | no       | A list of [curation sets](./curation.md#linking-curation-sets-with-collections) linked to the collection. <br/><br/>Default: `[]`.             |
...
| `geopolygon` | Geographic polygon defined by an array of coordinates specified as `[lat1, lng1, lat2, lng2, ...]`. Latitude/longitude pairs must be in counter-clockwise (CCW) or clockwise (CW) order. Read more [here](/30.2/api/geosearch.html#geographic-polygons). |
