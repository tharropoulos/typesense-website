...
| facet_sample_percent   | no       | Percentage of hits that will be used to estimate facet counts. Default: `100` (sampling is disabled by default).                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| facet_sample_threshold | no       | Minimum number of hits above which the facet counts are sampled. Default: `0`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
